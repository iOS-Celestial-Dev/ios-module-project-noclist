...
let hunt = (coverName: "Ethan Hunt", realName: "Tom Cruise", accessLevel: 8, compromised: false)
...
let kittridge = (coverName: "Eugene Kittridge", realName: "Henry Czerny", accessLevel: 10, compromised: true)
let krieger = (coverName: "Franz Krieger", realName: "Jean Reno", accessLevel: 4, compromised: false)
let stickell = (coverName: "Luther Stickell", realName: "Ving Rhames", accessLevel: 4, compromised: false)
let davies = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 5, compromised: true)
let rotgrab = (coverName: "Max RotGrab", realName: "Vanessa Redgrave", accessLevel: 4, compromised: false)
let williams = (coverName: "Hannah Williams", realName: "Ingeborga Dapkūnaitė", accessLevel: 5, compromised: true)
let harmon = (coverName: "Jack Harmon", realName: "Emilio Estevez", accessLevel: 6, compromised: true)
let barnes = (coverName: "Frank Barnes", realName: "Dale Dye", accessLevel: 9, compromised: false)


//: ## Step 2
//: Place the above constants inside an array. Declare this array as a constant as well.
var agents = [hunt, jPhelps, cPhelps, kittridge, krieger, stickell, davies, rotgrab, williams, harmon, barnes]


//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func numberOfCompromisedAgents(in agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) -> Int {
    var compromised = 0;
...
print("\(numberOfCompromisedAgents(in: agents)) agents have been compromised!")
...
func findCleanAgents(in agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) -> [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)] {
...
let uncompromisedAgents = findCleanAgents(in: agents)
print("\(uncompromisedAgents.count) clean agents out of \(agents.count) total agents.")
...
func findHighRisk(in agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
    for agent in agents {
...
func accessLevelTotals(in agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
    var low = 0
    var mid = 0
    var high = 0
    ...
    print("\(low) low level agent, \(mid) mid level agents, \(high) high level agents")
}


//: ## Step 10
//: Call the above function and check its output in the console.
accessLevelTotals(in: agents)
...
func coverNamesAndLevels(in agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
